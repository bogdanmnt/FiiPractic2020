...
public class JavaMailUtil {
	...
	public void sendMail(String recepient, String msg, Object obj) throws Exception {
		System.out.println("I am preparing to send an email...");
	...
	private Message prepareMessage(Session session, String myAccountEmail, String recepient, String msg, Object obj)
		...
		try {
			...
			message.setSubject("Hospital Notify");
	...
	String getRezultat(String textParam, Object obj) throws SecurityException, NoSuchMethodException,
	...
	String replace(String methodName, Object a) throws SecurityException, NoSuchMethodException,
			IllegalArgumentException, IllegalAccessException, InvocationTargetException {
